...
public class SetupRateList {
    ...
    public List<RatesListModel> addData(RatesModel ratesModel) {
        ...
        ratesListModels.add(new RatesListModel(ZAR, ZAR_CURRENCY, 0, getCurrencyRate(ratesModel.getZAR(), ZAR)));
        ratesListModels.add(new RatesListModel(INR, INR_CURRENCY, 0, getCurrencyRate(ratesModel.getINR(), INR)));
        ratesListModels.add(new RatesListModel(CNY, CNY_CURRENCY, 0, getCurrencyRate(ratesModel.getCNY(), CNY)));
        ratesListModels.add(new RatesListModel(THB, THB_CURRENCY, 0, getCurrencyRate(ratesModel.getTHB(), THB)));
        ratesListModels.add(new RatesListModel(AUD, AUD_CURRENCY, 0, getCurrencyRate(ratesModel.getAUD(), AUD)));
        ratesListModels.add(new RatesListModel(ILS, ILS_CURRENCY, 0, getCurrencyRate(ratesModel.getILS(), ILS)));
        ratesListModels.add(new RatesListModel(KRW, KRW_CURRENCY, 0, getCurrencyRate(ratesModel.getKRW(), KRW)));
        ratesListModels.add(new RatesListModel(JPY, JPY_CURRENCY, 0, getCurrencyRate(ratesModel.getJPY(), JPY)));
        ratesListModels.add(new RatesListModel(PLN, PLN_CURRENCY, 0, getCurrencyRate(ratesModel.getPLN(), PLN)));
        ratesListModels.add(new RatesListModel(GBP, GBP_CURRENCY, 0, getCurrencyRate(ratesModel.getGBP(), GBP)));
        ratesListModels.add(new RatesListModel(IDR, IDR_CURRENCY, 0, getCurrencyRate(ratesModel.getIDR(), IDR)));
        ratesListModels.add(new RatesListModel(HUF, HUF_CURRENCY, 0, getCurrencyRate(ratesModel.getHUF(), HUF)));
        ratesListModels.add(new RatesListModel(PHP, PHP_CURRENCY, 0, getCurrencyRate(ratesModel.getPHP(), PHP)));
        ratesListModels.add(new RatesListModel(TRY, TRY_CURRENCY, 0, getCurrencyRate(ratesModel.getTRY(), TRY)));
        ratesListModels.add(new RatesListModel(RUB, RUB_CURRENCY, 0, getCurrencyRate(ratesModel.getRUB(), RUB)));
