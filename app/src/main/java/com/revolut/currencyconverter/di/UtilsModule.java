...
import com.revolut.currencyconverter.utils.Urls;
...
public class UtilsModule {
    ...
    @Provides
    @Singleton
    RatesRepository getRepository(ApiCallInterface apiCallInterface) {
        return new RatesRepository(apiCallInterface);
    }

    @Provides
    @Singleton
    ViewModelProvider.Factory getViewModelFactory(RatesRepository ratesRepository) {
        return new ViewModelFactory(ratesRepository);
    }
}
